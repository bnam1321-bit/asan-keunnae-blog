            ...
            <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 sm:p-12 mb-12">
                    <div className="prose prose-lg prose-amber max-w-none
                        ...
                        prose-blockquote:bg-slate-50 prose-blockquote:border-l-4 prose-blockquote:border-blue-600 prose-blockquote:py-2 prose-blockquote:px-6 prose-blockquote:rounded-r-lg prose-blockquote:not-italic prose-blockquote:text-slate-700 prose-blockquote:my-8
                    ">
                ...
                <div className="bg-stone-50 rounded-3xl p-8 sm:p-10 mb-12 border border-stone-200">
                    <div className="flex items-center gap-4 mb-6">
                        <div className="w-24 h-16 bg-white flex items-center justify-center shadow-sm overflow-hidden border border-stone-200 p-1.5 rounded-xl shrink-0">
                            <img src="/images/logo.png" alt="아산큰내과 로고" className="w-full h-auto object-contain" />
                        </div>
                        <div>
