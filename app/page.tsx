...
export const metadata = {
  title: '건강정보 | 아산큰내과',
  description: '아산큰내과에서 전하는 올바른 건강 정보입니다.',
};
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      {/* Premium Hero Header */}
      <div className="relative overflow-hidden text-white bg-stone-900" style={{ backgroundImage: "url('/images/clinic-interior.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-28 sm:py-36">
          <div className="text-center">
            <div className="inline-flex items-center px-5 py-2.5 bg-white/10 backdrop-blur-md rounded-full mb-8 border border-white/20 shadow-lg">
              <span className="text-sm font-bold text-stone-50 tracking-wide">🏥 여성소화기내과 및 신장내과 전문의 진료</span>
            </div>
            ...
            {posts.map((post, index) => (
              <Link key={post.slug} href={`/blog/${post.slug}`} className="group">
                ...
                >
                  ...
                  {/* Content */}
                  <div className="p-6">
                    <h3 className="text-xl font-black text-stone-900 mb-3 line-clamp-2 group-hover:text-accent transition-colors leading-tight tracking-tight">
                      {post.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-stone-100">
                      <span className="text-accent text-sm font-bold group-hover:translate-x-2 transition-transform inline-flex items-center gap-2">
                        자세히 보기
